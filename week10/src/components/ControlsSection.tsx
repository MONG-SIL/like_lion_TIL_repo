...
const LOGIN_REQUIRED_TITLE = '로그인이 필요합니다';
...
export default function ControlsSection({
  ...
  const disabledTitle = controlsDisabled ? LOGIN_REQUIRED_TITLE : undefined;
      ...
      <div className="controls-groups">
        <div className="controls-basic" aria-label="기본 조작">
          ...
          <button
            ...
            disabled={!canDeleteLast || controlsDisabled}
            title={disabledTitle}
          >
            마지막 아기 사자 삭제
          </button>
        ...
        <div className="controls-fetch" aria-label="외부 데이터 불러오기">
          <div className="fetch-controls">
            <button
              ...
              className="btn"
              onClick={onFetchAdd1}
              disabled={isFetching || controlsDisabled}
              title={disabledTitle}
            >
              랜덤 1명 추가
            </button>
      ...
      >
        ...
        <div className="add-form__actions">
          <button
            ...
            title={isFillDisabled ? LOGIN_REQUIRED_TITLE : undefined}
          >
            랜덤 값 채우기
          </button>
