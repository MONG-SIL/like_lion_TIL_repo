...
export interface UseAddFormParams {
  onAdd: (lion: Lion) => void | Promise<void>;
...
export function useAddForm({
  ...
  isFetching,
  isAuthenticated,
}: UseAddFormParams): UseAddFormReturn {
  ...
  const canSubmit = isAuthenticated && isFormComplete(form);
  ...
  return {
    ...
    handleSubmit,
    handleFillRandom,
    isFillDisabled: isFetching || !isAuthenticated,
  };
}
